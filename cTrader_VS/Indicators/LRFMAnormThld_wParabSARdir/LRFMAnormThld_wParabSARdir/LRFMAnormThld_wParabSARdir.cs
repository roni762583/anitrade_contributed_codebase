...
namespace cAlgo
{
    ...
    public class LRFMAnormThld_wParabSARdir : Indicator
    {
        [Parameter()]
        ...
        [Output("LRF_Sig", Color = Colors.White, PlotType = PlotType.Histogram)]
        public IndicatorDataSeries Result { get; set; }
        [Output("ParabSAR_Sig", Color = Colors.Red)]
        ...
        public override void Calculate(int index)
        {
            ...
            Result2[index] = psar.Result[index] > MarketSeries.High[index] ? -1.0 : 1.0;
        }
    }
}
