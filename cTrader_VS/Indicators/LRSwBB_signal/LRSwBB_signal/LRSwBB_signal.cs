...
namespace cAlgo
{
    ...
    public class LRSwBB_signal : Indicator
    {
        ...
        public int linRegSlpPeriods { get; set; }
        ...
        private IndicatorDataSeries llrrss;
        ...
        public override void Calculate(int index)
        {
            ...
            pctB[index] = (llrrss[index] - bb.Bottom[index]) / (bb.Top[index] - bb.Bottom[index]);
