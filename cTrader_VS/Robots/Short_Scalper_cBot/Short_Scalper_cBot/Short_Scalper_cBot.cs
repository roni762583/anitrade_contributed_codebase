...
namespace cAlgo
{
    ...
    public class Short_Scalper_cBot : Robot
    {
        [Parameter("Initial Target Ticks", DefaultValue = 20)]
        public int initTargetTicks { get; set; }

        [Parameter("Symetric Half Zone Pips", DefaultValue = 300)]
        public int halfZoneTicks { get; set; }

        [Parameter("Symetric Targets Beyond Zone Pips", DefaultValue = 250)]
        ...
        private const string label = "Short_Scalper_cBot";
