...
namespace cAlgo
{
    ...
    public class Long_Scalper_cBot_mpf : Robot
    {
        [Parameter("Initial Target Ticks", DefaultValue = 75)]
        public int initTargetTicks { get; set; }

        [Parameter("Symetric Half Zone Pips", DefaultValue = 350)]
        public int halfZoneTicks { get; set; }

        [Parameter("Symetric Targets Beyond Zone Pips", DefaultValue = 1000)]
        ...
        private const string label = "Long_Scalper_cBot_mpf";
