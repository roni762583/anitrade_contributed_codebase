...
extern int MA1Periods=10;
extern string MA2Array = "Close";
extern int MA2Periods=20;
...
{    
     ...
     if( UseCompletedBars )
     {
      ...
      if( CountAll( Sym, MagicNumber) == 0)
      {
         ...
         v11 = iCustom(NULL, 0,"Zero Lag Average",MA1Array,MA1Periods,MODE_MAIN,0+RealTime); 
         v12 = iCustom(NULL, 0,"Zero Lag Average",MA1Array,MA1Periods,MODE_MAIN,1+RealTime); 
         v21 = iCustom(NULL, 0,"Zero Lag Average",MA2Array,MA2Periods,MODE_MAIN,0+RealTime); 
         v22 = iCustom(NULL, 0,"Zero Lag Average",MA2Array,MA2Periods,MODE_MAIN,1+RealTime); 

              if( v11 > v21 && v12 < v22 ) { EnterLong(Sym, Lots, ""); }
         else if( v11 < v21 && v12 > v22 ) { EnterShrt(Sym, Lots, ""); }
      }
      //----
