//+------------------------------------------------------------------+
//|                             AZ_EA_eFFSO_MTF_X_eFIRMXMMF_book.mq4 |
//|                                                          Aharon. |
...
// Trading criteria
   //entry signal 
   signal1 = iCustom(NULL, 0, "Aharon_eFFSO_MTF", 
   ...
   signal2 = iCustom(NULL, 0, "eAharon_FIRMXMMF",
                     TF1m, Period1, Taps1, Window1, MA1Period, MA1shift, MA1method, MA2Period, MA2shift, MA2method,
                     0, 0);  //  1.0, -1.0
   
   
   
   if (signal1 == 1.0 && signal2 == 1.0 && Total==0)     {                   // if flat and entry signal up;                           
      Opn_B=true;                                          // Criterion for opening Buy
   }
   
   if (signal1 == -1.0 && signal2 == -1.0  && Total==0)     {                  // if flat and entry signal down;                           
