// A_i_BB7BASlp_Acc.mq4 //add Accel. of avg. slope of line (7 bar ave. diff. in pip/min), by avg. last 4 point's diff.
//+------------------------------------------------------------------+
...
//---- name for DataWindow and indicator subwindow label
   string short_name;
   short_name="BB7BASlp_Acc("+BandsDeviations+", "+BandsPeriod+")";
...
// Set values
   for(i=0; i<limit; i++)  {
      D[i]=iCustom(NULL, 0, "Aharon_7_Bar_Avg_Slope_Pips_per_Min", 0, i);         //iATR(NULL, 0, AtrPeriod, i);
   }
