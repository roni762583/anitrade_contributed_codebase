...
//---- name for DataWindow and indicator subwindow label
   string short_name;
   short_name="BB_on_Range("+RangePeriod+", "+BandsDeviations+", "+BandsPeriod+")";
   IndicatorShortName(short_name);
   SetIndexLabel(0,"Range Avg.");
...
// Set values
   ...
   for(i=0; i<limit; i++)  {
      D[i]= High[i] - Low[i]; //iMAOnArray(R, 0, RangePeriod, 0, MODE_SMA, i);
   //Print("ii=",i);  
   //if(i==12) break;
   }
