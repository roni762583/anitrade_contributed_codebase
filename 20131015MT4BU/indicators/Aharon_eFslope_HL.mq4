...
int start()  {
   ...
   for(i=0; i<limit; i++)  {
      p0 =  iCustom(NULL, 0, "Aharon_eFF_L", Period1, Taps1, Window1, 2, i);    //avgs represent prices
      p1 =  iCustom(NULL, 0, "Aharon_eFF_L", Period1, Taps1, Window1, 2, i+1);
      p01 = (p0 - p1) * MathPow(10,Digits);
      eFslope_L[i] = p01/t;
   }
   
   for(i=0; i<limit; i++)  {
      p0 =  iCustom(NULL, 0, "Aharon_eFF_H", Period1, Taps1, Window1, 2, i);    //avgs represent prices
      p1 =  iCustom(NULL, 0, "Aharon_eFF_H", Period1, Taps1, Window1, 2, i+1);
      p01 = (p0 - p1) * MathPow(10,Digits);
      eFslope_H[i] = p01/t;
   }
