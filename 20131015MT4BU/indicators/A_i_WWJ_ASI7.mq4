...
//+------------------------------------------------------------------+
//like A_i_WWJ_ASI3.mq4 , just adds sma on asi line
...
int init()  {
   ...
   SetIndexLabel(3, "smaONasi");
   SetIndexStyle(3,  DRAW_LINE);
   SetIndexBuffer(3, smaONasi);
...
int start()  {
   ...
   for(i=BarsBack; i>=0; i--) {
      smaONasi[i] = iMAOnArray(asi, 0, 15, 0, 0, i);
   }
