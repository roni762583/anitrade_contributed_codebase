//+------------------------------------------------------------------+
//|                                           Aharon_FIRMA_ARMA3.mq4 |
//|                                         Copyright © 2009, Aharon |
//|                                           http://www.anitani.net |
//+------------------------------------------------------------------+
//+------------------------------------------------------------------+
//|                                            Aharon_FIRMA_ARMA2.mq4 |
//|                                         Copyright © 2009, Aharon |
//|                                           http://www.anitani.net |
//+------------------------------------------------------------------+
...
//Initialize indicator
   ...
   SetIndexBuffer(2, Maxima);
   SetIndexBuffer(3, Minima);
  ...
  //..................................................................
   ...
   for(i = 0; i <= n; i++)
       ...
       for(i = start; i <= Bars; i++)
          {  //Maxima
             if(FIRMA[i]<FIRMA[i+1] && FIRMA[i+1]>FIRMA[i+2])
                {
                   Maxima[i+1]=FIRMA[i+1]; 
                   LastMax = FIRMA[i+1];
                   //Maxima[i]=FIRMA[i+1];
                }
             else 
                {
                   Maxima[i+1]=LastMax; //maxima
                }
                
             //Minima
             if(FIRMA[i]>FIRMA[i+1] && FIRMA[i+1]<FIRMA[i+2])
                {
                   Minima[i+1]=FIRMA[i+1]; 
                   LastMin = FIRMA[i+1];
                   
                }
             else 
                {
                   Minima[i+1]=LastMin; //maxima
                }
        }
       ////////////
   return(0);
