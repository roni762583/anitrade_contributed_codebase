//+------------------------------------------------------------------+
//|                              Aharon_FIRMA_MA_MA_Full_Ordered.mq4 |
//|                                                           Aharon |
//|                                        http://www.metaquotes.net |
//+------------------------------------------------------------------+
//+------------------------------------------------------------------+
//|                                   Aharon_FIRMA_MA_MA_Ordered.mq4 |
//|                                                           Aharon |
//|                                        http://www.metaquotes.net |
//+------------------------------------------------------------------+
//+------------------------------------------------------------------+
...
0 (zero) 0 Timeframe  
//////////////////////////////////////////////////////////////////////////////*/
//  Initialization values are those tested
...
int init()   {
   ...
   string short_name;
   short_name = "FIRMA_MA_MA_Full_Ordered(" + Period1 + ", " + MA1Period + ", " + MA2Period + ")";
...
int start()   {
   ...
   for(i=0; i<limit; i++)  {
      ...
      if(  
         (  (FIRMA[i] > MA1[i] && MA1[i] > MA2[i])  ||  (FIRMA[i] < MA1[i] && MA1[i] < MA2[i])   )  
         &&
         (  (FIRMA[i-1] > MA1[i-1] && MA1[i-1] > MA2[i-1])  ||  (FIRMA[i-1] < MA1[i-1] && MA1[i-1] < MA2[i-1])   )  &&
         (  (FIRMA[i-2] > MA1[i-2] && MA1[i-2] > MA2[i-2])  ||  (FIRMA[i-2] < MA1[i-2] && MA1[i-2] < MA2[i-2])   ) 
        )  
