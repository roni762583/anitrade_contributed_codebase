...
//---- name for DataWindow and indicator subwindow label
   string short_name;
   short_name="Aharon_FMSlopeWBBpctOvrsht("+BandsDeviations+", "+BandsPeriod+", Thld:"+ThldDecimal+")";
...
int start()   {
   ...
   for(i=0; i<limit; i++)  {  //from last going back
      ...
      if(iCustom(NULL, 0, "Aharon_FIRMA_Slope_w_BB", BandsDeviations, BandsPeriod, 0, i)  >= 
         iCustom(NULL, 0, "Aharon_FIRMA_Slope_w_BB", BandsDeviations, BandsPeriod, 1, i) * ThldDecimal)   {
         ...
         S[i]= ((iCustom(NULL, 0, "Aharon_FIRMA_Slope_w_BB", BandsDeviations, BandsPeriod, 0, i) -
               ...
               (iCustom(NULL, 0, "Aharon_FIRMA_Slope_w_BB", BandsDeviations, BandsPeriod, 1, i))*100);   //up signal
      }
      ...
      if(iCustom(NULL, 0, "Aharon_FIRMA_Slope_w_BB", BandsDeviations, BandsPeriod, 0, i)  <=
         ...
         S[i]= ((iCustom(NULL, 0, "Aharon_FIRMA_Slope_w_BB", BandsDeviations, BandsPeriod, 2, i) -
                 iCustom(NULL, 0, "Aharon_FIRMA_Slope_w_BB", BandsDeviations, BandsPeriod, 0, i) ) /
               (iCustom(NULL, 0, "Aharon_FIRMA_Slope_w_BB", BandsDeviations, BandsPeriod, 2, i))*100);   //down signal
      }
