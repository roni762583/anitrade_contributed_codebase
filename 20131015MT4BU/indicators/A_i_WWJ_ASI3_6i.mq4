...
extern int    BarsBack  = 300;  //how far back to calculate
...
int init()  {
   IndicatorBuffers(1);
   string short_name;
   short_name = "A_i_WWJ_ASI3_6i(" + BarsBack + ")";
...
//   int asi0, asi1, asi2;
 //  bool nlv, nhv;
   ...
   for(i=BarsBack; i>=0; i--) {
      if(iCustom(NULL, 0, "A_i_WWJ_ASI3_6", BarsBack, 2, i)>iCustom(NULL, 0, "A_i_WWJ_ASI3_6", BarsBack, 0, i)) s[i]=1.0; //if asi>h
      if(iCustom(NULL, 0, "A_i_WWJ_ASI3_6", BarsBack, 2, i)<iCustom(NULL, 0, "A_i_WWJ_ASI3_6", BarsBack, 1, i)) s[i]=-1.0;//if asi<l
      if(iCustom(NULL, 0, "A_i_WWJ_ASI3_6", BarsBack, 2, i)>=iCustom(NULL, 0, "A_i_WWJ_ASI3_6", BarsBack, 1, i) &&        //if asi in btwn
         iCustom(NULL, 0, "A_i_WWJ_ASI3_6", BarsBack, 2, i)<=iCustom(NULL, 0, "A_i_WWJ_ASI3_6", BarsBack, 0, i) ) s[i]=0.0;
   /*
