...
int init()   {
   ...
   string short_name;
   short_name = "Aharon_Mamase(" + Period1 + ", " + MA1Period + ", " + MA2Period + ", " + 
...
int start()   {
   ...
   for(i=0; i<limit; i++)  {
      ...
      Mom[i]= (iMomentumOnArray(MA2, 0, MomLength, i) -100)*MathPow(10,Digits);
   ...
   - Is momentum line above/below BB?
   - Calculate slope of FIR MA +/- ?
