...
//---- name for DataWindow and indicator subwindow label
   string short_name;
   short_name="Bands_on_MomOverSD("+SDperiod+", "+BandsDeviations+", "+BandsPeriod+")";
...
// Set values
   for(i=0; i<limit; i++)  {
      D[i]= (Close[i]-Close[i+1])/MathMax(iStdDev(Symbol(),0,SDperiod,0,MODE_SMA,PRICE_CLOSE,i), Point/1000.0);
   }
   for(i=0; i<limit; i++)  {
