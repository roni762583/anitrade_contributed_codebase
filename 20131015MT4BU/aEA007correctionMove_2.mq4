...
//+------------------------------------------------------------------+
//in this version, current bar is considered to verify original move has completed,
//also uses BB on ATR as opposed to range (can set atr to period to 1 and get same as range)
...
int start(){
   ...
   //set signals
   if(   iCustom(NULL, 0, "Aharon_Bands_on_ATR", BDev, BPeriod, ATRperiod, 0, 1) > 
         iCustom(NULL, 0, "Aharon_Bands_on_ATR", BDev, BPeriod, ATRperiod, 1, 1)   ) s1 = 1.0; //is range out of BB
   else s1 = 0.0;
   
   if(   iCustom(NULL, 0, "Aharon_Bands_on_ATR", BDev, BPeriod, ATRperiod, 0, 1) > 
         iCustom(NULL, 0, "Aharon_Bands_on_ATR", BDev, BPeriod, ATRperiod, 1, 1)   ) s10 = 1.0; //is range out of BB
   else s10 = 0.0;
