...
extern int    CCIperiod  = 45;
extern int    CCIappliedPrice = PRICE_MEDIAN;
...
// Trading criteria
   ...
   signal0 = iCCI(Symbol(), Period(), CCIperiod, CCIappliedPrice, 0);
   signal1 = iCCI(Symbol(), Period(), CCIperiod, CCIappliedPrice, 1);
   if (signal0>0 && signal1<0)     {                   // if flat and signal up;                           
      Opn_B=true;  
     // Cls_S=true;                                        // Criterion for opening Buy
   }
   
   if (signal0<0 && signal1>0)     {                  // if flat and signal down;                           
      Opn_S=true; 
