...
//--------------------------------------------------------------- 5 --////////////////////
// Trading criteria
   if(iCustom(Symbol(), Period(), "Aharon_eFF_C_inversion", Periods, Taps, Window,  0, i+1) == 1.0) signal0 = -1.0;
   if(iCustom(Symbol(), Period(), "Aharon_eFF_C_inversion", Periods, Taps, Window,  0, i+1) == -1.0) signal0 = 1.0;

   if (signal0 == 1.0 && Total == 0)  Opn_B=true;  
   if (signal0 == 1.0)                Cls_S=true;
      
   if (signal0 == -1.0 && Total == 0) Opn_S=true; 
   if (signal0 == -1.0)               Cls_B=true; 
