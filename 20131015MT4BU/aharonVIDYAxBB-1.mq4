//+------------------------------------------------------------------+
//|                                             aharonVIDYAxBB-1.mq4 |
//|                      Copyright © 2013,     aharon Software Corp. |
//|                                       http://www.google.com      |
//+------------------------------------------------------------------+
//-1 changed >0 in for loop to >=0  04/07/2013
...
void start()   {
   ...
   if(firstTime){
      Print("DATE",",","Time",",","ubb",",","lbb",",","vma[0]",",","vma[1]",",","Bid",",","Ask");
      firstTime=false;
   }
   if(isNewBar())   {
      Print(TimeToStr(Time[0], TIME_DATE),",",TimeToStr(Time[0],TIME_MINUTES),",",ubb,",",lbb,",",vma[0],",",vma[1],",",Bid,",",Ask);
      return;
   }
