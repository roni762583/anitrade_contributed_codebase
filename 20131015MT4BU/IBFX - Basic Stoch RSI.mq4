...
extern int STOCHK_Periods = 10;
extern int STOCHD_Periods = 3;
...
{    
     ...
     if( UseCompletedBars )
     {
      ...
      {
         double ind1 = iCustom(NULL,0,"Stoch RSI",array,RSI_Periods,STOCHK_Periods,STOCHD_Periods,0,0+RealTime);
         double ind2 = iCustom(NULL,0,"Stoch RSI",array,RSI_Periods,STOCHK_Periods,STOCHD_Periods,1,1+RealTime);

              if(ind1 > 20.0 && ind2 < 20.0) {EnterLong(Sym, Lots, "");}
         else if(ind1 < 80.0 && ind2 > 80.0) {EnterShrt(Sym, Lots, "");}
      }
      //----
